...
namespace TestProject1
{
    ...
    public class UnitTest1
    {
        ...
        public void CheckModification()
        {
            ...
            Console.WriteLine((int)numeralPeptide[0]);
        ...
        public void InitiateNumMod()
        {
            ...
            for (int i = 0; i < ionLi.Count; i++)
            {
                ...
                Console.WriteLine("label: " + testResult[i].Label);
                Console.WriteLine(" Iontype: " + testResult[i].IonType);
                Console.WriteLine("  mass-to-charge : " + testResult[i].MZ);
            }
